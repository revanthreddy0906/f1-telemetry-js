...
import { x as RawTelemetryInput, F as FormattedTelemetry, aa as TelemetryValidationOptions, ab as TelemetryValidationResult, a7 as TelemetryTimeReference, ah as TyreClassification, u as LapTime, t as LapSectors, j as DriverLapTelemetry, f as DeltaPoint, af as TimeDeltaPoint, n as DriverPositionHistory, O as OvertakeEvent, g as DistanceBasedTelemetry, d as CsvExportOptions, J as JsonExportFormat, ai as TyreCompound } from './telemetry-CQTgwsmr.js';
export { A as AdapterName, a as AdapterParseOptions, b as AdaptiveDownsampleOptions, D as DataProcessingOptions, h as DownsampleStrategy, I as IssueSeverity, s as LapComparisonMode, y as RawTelemetryPoint, z as SectorSplit, T as TelemetryAdapterDiagnostic, N as TelemetryAdapterDiagnostics, Q as TelemetryAdapterResult, U as TelemetryAnnotation, V as TelemetryAnnotationType, W as TelemetryChartType, X as TelemetryDashboardLayout, Y as TelemetryDashboardLayoutItem, Z as TelemetryDashboardProps, _ as TelemetryEvent, $ as TelemetryExtraChannel, a0 as TelemetryPanelContextMenuAction, a1 as TelemetryPanelExtension, a2 as TelemetryPanelRenderContext, a3 as TelemetrySeriesKey, a4 as TelemetrySeverity, a5 as TelemetrySharedChannelApi, a6 as TelemetryStyleTokens, a8 as TelemetryValidationDiagnostics, a9 as TelemetryValidationIssue, ac as TelemetryWindow, ad as ThemeMode, al as ValidationMode } from './telemetry-CQTgwsmr.js';
export { findNearestIndex, processSeriesData, processSeriesDataInWorker } from './performance.js';
import 'react';
...
interface NormalizeTelemetryTimeOptions {
    timeReference?: TelemetryTimeReference;
}
/**
 * Normalize telemetry time arrays/events into a consistent relative timeline.
 */
declare const normalizeTelemetryTime: (telemetry: FormattedTelemetry, options?: NormalizeTelemetryTimeOptions) => FormattedTelemetry;
